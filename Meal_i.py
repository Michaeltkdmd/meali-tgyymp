...
with st.expander("**FOOD LIST**"):
    st.write("**|Fruit|**", "/Apples","/Bananas", "/Oranges", "/Strawberries", "/Blueberries","/Raspberries", "/Avocado","/Grapefruit","/Mango","/Pears", "/Grapes", "/Lemons", "/Limes", "/Peaches", "/Watermelon","/Pomegranates", "/Plums", "/Plantain", "/Pineapple","/Payapa", "/Coconut", "/Guava", "/Dates", "/Dewberry", "/Cherries",
